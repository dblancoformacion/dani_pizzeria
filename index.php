		...
		");
			...
			sql2js('datos','dani_pizzeria',"
				SELECT id_local id,
  				...
  				FROM (SELECT DISTINCT id_local FROM venden 
  						WHERE id_servicio=".$_GET['id_servicio'].") c1 
  						JOIN locales 
  						USING(id_local);
				");
		}else{
			$sql="
    		 ...
    		 if(isset($_GET['id_local'])) $sql.=" AND id_local=".$_GET['id_local'];
			...
			";
			sql2js('datos','dani_pizzeria',$sql);
			}
		}

		/*
		
id_local=2 posee menos artículos 
